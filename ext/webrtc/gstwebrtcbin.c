    ...
    GstStructure * init_params)
{
   ...
   * [RTCWEB-DATA-PROTOCOL], and skip to the next step. If no available ID
   * could be generated, or if the value of the [[DataChannelId]] slot is
   * being used by an existing RTCDataChannel, throw an OperationError
   * exception.
   */
