...
/**
 * GstGLUploadElementReturn:
 * @GST_GL_UPLOAD_ELEMENT_DONE: No further processing required
 * @GST_GL_UPLOAD_ELEMENT_ERROR: An unspecified error occured
 * @GST_GL_UPLOAD_ELEMENT_UNSUPPORTED: The configuration is unsupported.
 */
typedef enum
{
  GST_GL_UPLOAD_ELEMENT_DONE = 1,

  GST_GL_UPLOAD_ELEMENT_ERROR = -1,
  GST_GL_UPLOAD_ELEMENT_UNSUPPORTED = -2,
  /* <private> */
  GST_GL_UPLOAD_ELEMENT_UNSHARED_GL_CONTEXT = -3,
} GstGLUploadElementReturn;
...
struct _GstGLUploadElement
{
  ...
  GstGLUploadElementPrivate *priv;
};
